...
# --- ГРАФИК 3: Bar Chart - Топ товаров по количеству поставщиков ---
plt.subplot(2, 2, 3)
# Берем топ-10 товаров с наибольшим числом поставщиков
top_supplied = df_suppliers.head(10)
sns.barplot(x='supplier_count', y='product_name', data=top_supplied, palette='viridis')
plt.title('Топ-10 товаров по количеству поставщиков')
plt.xlabel('Количество поставщиков')
plt.ylabel('Название товара')

# Обоснование выбора:
# Столбчатая диаграмма (Bar Chart) лучше всего подходит для сравнения дискретных значений (количества).
...
print("\n3. График: Количество поставщиков")
print("   - Выводы: Показывает, какие товары наиболее популярны у поставщиков или критически важны для бизнеса.")
print("   - Аномалии: Товары с 0 поставщиков (если такие есть в LEFT JOIN) — это товары, которые некому поставлять.")